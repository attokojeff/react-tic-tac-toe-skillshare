...
function TicTacToe() {
  ...
  function takeTurn(position) {
    ...
    setState({ player: state.player == CIRCLE ? CROSS : CIRCLE, positions });
...
function detectWinner(p) {
  ...
  if (p.every(position => position != EMPTY)) return "You f***n tied!";
}
...
function Result({ winner, reset }) {
  return /*#__PURE__*/(
    ...
    winner == 'You f***n tied!' && 'You f***n tied!', /*#__PURE__*/
